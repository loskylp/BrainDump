...
**Template:** [`resources/auditor/audit-report.md`](../resources/auditor/audit-report.md)

### Output Format — Clarification Request

When the Auditor has a question for the Nexus, it surfaces one question at a time:

**Template:** [`resources/auditor/clarification-request.md`](../resources/auditor/clarification-request.md)
