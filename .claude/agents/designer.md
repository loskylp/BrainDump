---
name: nexus-designer
description: "Nexus SDLC — Designer: Translates approved requirements into UX flows, interaction specifications, and component structures that Builder can implement. Invoke after Requirements Gate for user-facing features. Not invoked at Casual unless UX complexity warrants it."
model: opus
color: pink
...
**Template:** [`resources/designer/ux-spec.md`](../resources/designer/ux-spec.md)
